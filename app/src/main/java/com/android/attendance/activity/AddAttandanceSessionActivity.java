...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] subjectSEString = new String[] {"ISYB201","MCPB201"};
	private String[] subjectTEString = new String[] {"APDB201","APDP201"};
	private String[] subjectBEString = new String[] {"ITPM101","CMEP201"};

	private String[] subjectFinal = new String[] {"ISYB201","MCPB201","APDB201","APDP201","ITPM101","CMEP201"};
